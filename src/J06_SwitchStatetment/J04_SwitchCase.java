...
public class J04_SwitchCase {
    public static void main(String[] args) {
        ...
        switch (ayNo) {
            default:
                System.out.println("dogru bir ay numarası gir 1 ila 12 arası");
                break;
            case 1:
            case 3:
            case 5:
            ...
            case 9:
            case 11:
                System.out.println("girdiginiz ay 30 gun icerir");
                break;
            case 2: // iki durum 28 29 olmasi
                ...
                if ((yil % 4 == 0 && yil % 100 !=0 )  || yil % 400==0){
                    System.out.println("girdiginiz ay 29 gun icerir "+yil+" da ");
                }
                else
                    System.out.println("28 gün icerir");
