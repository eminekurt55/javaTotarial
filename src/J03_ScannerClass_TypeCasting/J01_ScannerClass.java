...
public class J01_ScannerClass {
    ...
    public static void main(String[] args) {
       ...
       //System.out.println("sifreni gir"); //2. adım
       ...
       //System.out.println("karenin kenarını gir"); // kullanıcıya kenar girme komutu verildi.
       //int kenar = input.nextInt(); //kullanıcının girdigi integer deger kenar variable ına atama yapılır
...
*/
        // System.out.println("gunluk cay sayısını gir:");
        // int caySayısı = input.nextInt();

        // System.out.println("caya kaç seker atarsın:");
        // int sekerSayısı = input.nextInt();

        //tem.out.println("yılda ictigin çay sayısı="+ (caySayısı*365));
        //stem.out.println("yılda tükettigin seker miktarı kg cinsinden:"+ (caySayısı*sekerSayısı*1.7*365)/1000);
        ...
        char ilkHarfi = name.charAt(0);
        System.out.println("ilkHarfi :" +ilkHarfi);
       ...
       //System.out.println("name.length() = " + name.length());//kactane harften olustugu yazdirildi
        ...
        System.out.println(name.length() ); //kac tane harften oluştugu yazdırıldı
